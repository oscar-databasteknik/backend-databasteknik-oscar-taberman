...
{
    /// <inheritdoc />
    public partial class ExpandEducationSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_CourseSessions_CourseSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentContactInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentContactInformations_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_CourseSessionId",
                table: "Lessons",
                column: "CourseSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentContactInformations_StudentId",
                table: "StudentContactInformations",
                column: "StudentId",
                unique: true);
